...
<body class="nav-md">
						...
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								<a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
									<img src="image_50384129.JPG" alt=""ala eddine aoun
								</a>
    ...
    <?php
       ...
       if(isset($_POST['button'])){
           ...
           if(  isset($matricule) && isset($marque) && isset($couleur) && isset($kilometrage) && isset($carburant)&& isset($image)){
				...
				$message="connectee";
                //requête d'ajout
                $req = mysqli_query($con , "INSERT INTO vehicule VALUES( '$matricule','$marque','$couleur','$kilometrage','$carburant','$image')");
